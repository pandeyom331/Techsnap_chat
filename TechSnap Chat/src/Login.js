    ...
    return (
        <div className="login">
            <div className="login__container">
                <img src="/logo1.png" alt="TechSnap Logo" />
                <div className="login__text">
                    <h1>Sign In to TechSnap-Chat</h1>
                </div>
                <Button className="Google" onClick={signIn_Google}><img src="/google.png" alt="TechSnap Logo" className="G_img"/>Sign In With Google</Button>
                <br />
